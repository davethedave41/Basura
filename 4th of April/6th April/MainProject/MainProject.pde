...
LinePlot lineplot, businessLinePlot;
BarChart barChart;
...
void setup () {
  ...
  Widget busWidget1 = new Widget(500, 200, 350, 40, "Carini's Homemade Ice Cream & Gelato", widgetColor, widgetFont, EVENT_BUTTON10);
  Widget busWidget2 = new Widget(500, 250, 350, 40, "Quicktrip No 453", widgetColor, widgetFont, EVENT_BUTTON11);
  Widget busWidget3 = new Widget(500, 300, 350, 40, "Barrio Fiesta - The Original", widgetColor, widgetFont, EVENT_BUTTON12);
  Widget busWidget4 = new Widget(500, 350, 350, 40, "Sally Beauty Supply", widgetColor, widgetFont, EVENT_BUTTON13);
  Widget busWidget5 = new Widget(500, 400, 350, 40, "Phoenix Pharmacy", widgetColor, widgetFont, EVENT_BUTTON14);
  Widget busWidget6 = new Widget(500, 450, 350, 40, "Impact Auto Glass & Tint", widgetColor, widgetFont, EVENT_BUTTON15);
  Widget busWidget7 = new Widget(500, 500, 350, 40, "Liberty", widgetColor, widgetFont, EVENT_BUTTON16);
  Widget busWidget8 = new Widget(500, 550, 350, 40, "Plantation Animal Clinic", widgetColor, widgetFont, EVENT_BUTTON17);
  Widget busWidget9 = new Widget(500, 600, 350, 40, "Super Star Car Wash", widgetColor, widgetFont, EVENT_BUTTON18);
  ...
  if (screenInt == 2) {
    for (int i =0; i<bizWidgets.size(); i++) {
      ...
      case EVENT_BUTTON10:
        println("One");
        screenInt = 1;
        busName = "Carini's Homemade Ice Cream & Gelato";
...
void filterByBusinessName(String name) {
  ...
  busName = name;
  reviewNumDisplayed = 0;
  int[] statistics=findReviews(busName);
  businessLinePlot=new LinePlot(50, 60, 10, 100, 900, 700, 500, "Review Activity", "Years", "Reviews", 1, 11, 10, 4, statistics, busName);
  //ArrayList<Review> displayReviewsArray = reviewScreen.filterReviews(busName);
  businessProfile = new ReviewScreen(widgetList, backgroundTemplate, reviewsArray, reviewNumDisplayed, businessLinePlot);

...
//  int cR=4;
 ...
 String useful="Useful", funny="Funny", cool="Cool", stars="Stars";
  ...
  void draw() {
    ...
    stdFont = loadFont("AgencyFB-Reg-32.vlw");
    fill(255,5,5);
    ...
    switch(review.getUseful()){
      case 1:
      fill(255,0,0);
     rect(barX+barWidthV, barY, barGraphWidth,-1*(oneRating*review.getUseful()));
     break;
     case 2:
     fill(255,0,0);
     rect(barX+barWidthV, barY, barGraphWidth,-1*(oneRating*review.getUseful()));
     ...
     case 5:
     fill(255,0,0);
      rect(barX+barWidthV, barY-1, barGraphWidth,-1*(oneRating*review.getUseful()));
     break;
     default:
     break;
    }
    ...
    case 1:
     fill(0,255,0);
    rect(barX+barWidthV+barGraphWidth,barY,barGraphWidth,-1*(oneRating*review.getFunny()));
    break;
    case 2:
     fill(0,255,0);
    rect(barX+barWidthV+barGraphWidth,barY,barGraphWidth,-1*(oneRating*review.getFunny()));
    ...
    case 1:
    fill(0,0,255);
    rect(barX+barWidthV+2*barGraphWidth,barY,barGraphWidth,-1*(oneRating*review.getCool()));
    break;
    case 2:
    fill(0,0,255);
    rect(barX+barWidthV+2*barGraphWidth,barY,barGraphWidth,-1*(oneRating*review.getCool()));

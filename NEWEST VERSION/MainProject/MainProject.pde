...
ArrayList<Widget> widgetList, otherWij;
PFont widgetFont;
float y = 100;
...
void setup () {
  ...
  businessScreen = new Screen(widgetList, backgroundTemplate, businessNames);
  userScreen = new Screen(widgetList, backgroundTemplate, userNames);
  homeScreen = new HomeScreen(widgetList, backgroundTemplate, userText);

...
void setup () {
  ...
  Widget busWidget1 = new Widget(700, 200, 200, 40, "Carini's", widgetColor, widgetFont, EVENT_BUTTON10);
  Widget busWidget2 = new Widget(700, 250, 200, 40, "Quicktrip", widgetColor, widgetFont, EVENT_BUTTON11);
  Widget busWidget3 = new Widget(700, 300, 200, 40, "Barrio Fiesta", widgetColor, widgetFont, EVENT_BUTTON12);
  Widget busWidget4 = new Widget(700, 350, 200, 40, "Sally Beauty", widgetColor, widgetFont, EVENT_BUTTON13);
  Widget busWidget5 = new Widget(700, 400, 200, 40, "Phoenix Pharmacy", widgetColor, widgetFont, EVENT_BUTTON14);
  Widget busWidget6 = new Widget(700, 450, 200, 40, "Impact Auto", widgetColor, widgetFont, EVENT_BUTTON15);
  Widget busWidget7 = new Widget(700, 500, 200, 40, "Liberty", widgetColor, widgetFont, EVENT_BUTTON16);
  Widget busWidget8 = new Widget(700, 550, 200, 40, "Plantation Animal", widgetColor, widgetFont, EVENT_BUTTON17);
  Widget busWidget9 = new Widget(700, 600, 200, 40, "Super Star", widgetColor, widgetFont, EVENT_BUTTON18);
